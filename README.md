...
Tenho domínio em *Excel* e *Power BI* (ETL/ELT, modelagem de dados, DAX e construção de dashboards), além de experiência com *Python e SQL* em projetos guiados.

Sou pós-graduanda em *Análise de Dados e Inteligência Artificial* e estou em transição de carreira, trazendo uma base sólida em *negócios, marketing digital e gestão*, o que fortalece minha capacidade de entender o contexto do negócio, traduzir necessidades e conectar dados a decisões reais.
